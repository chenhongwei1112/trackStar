...
class m130616_031508_add_role_to_tbl_project_user_assignment extends CDbMigration
{
	public function up()
	{
	...
	{
		$this->dropForeignKey('fk_project_user_role', 'tbl_project_user_		assignment');
